...
The project is hosted [here](https://gitlab.com/xrop/sha-256).
I also implemented SHA-512, which is hosted
[here](https://gitlab.com/xrop/sha-512).

Blockchains have always been on my mind, so perhaps I will implement a little
blockchain next.
My purpose in doing these little projects have been to understand how these
...
doing if I can recreate a library.
